...
const STATUS_CONTENT_MAP: MapType = {
  succeeded: {
...
const StripeSuccessPage = () => {
  ...
  }, [searchParams, stripe, navigate, status, ID]);
      ...
      {intentId && (
        <div id="details-table">
          <Table>
            <TableBody>
              <TableRow>
                <TableCell className="TableLabel">IntendId:</TableCell>
                <TableCell id="intent-id">{intentId}</TableCell>
              </TableRow>
              <TableRow>
                <TableCell className="TableLabel">Status:</TableCell>
                <TableCell id="intent-status">{status}</TableCell>
              </TableRow>
            </TableBody>
          </Table>
        </div>
